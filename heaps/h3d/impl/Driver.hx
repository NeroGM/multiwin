...
typedef VertexBuffer = { b : sdl.GL.Buffer, stride : Int #if multidriver, driver : Driver #end}; // <--
typedef Texture = { t : sdl.GL.Texture, width : Int, height : Int, internalFmt : Int, pixelFmt : Int, bits : Int, bind : Int, bias : Float #if multidriver, driver : Driver #end}; // <--
typedef DepthBuffer = { r : sdl.GL.Renderbuffer #if multidriver, driver : Driver #end}; // <--
